...
class ConceptNetwork():
    ...
    def from_lattice(
        ...
        # attrs_tpl = tuple(lattice[lattice.bottom_element].intent)
    ...
    def fit(
        ...
        optimizer = torch.optim.Adam(self.network.parameters(), lr = 0.001, betas = (0.9, 0.999)) # 0.001
    ...
    def fit_2(
        ...
        #optimizer = torch.optim.SGD(self.network.parameters(), lr = 1)
        optimizer = torch.optim.Adam(self.network.parameters(), lr = 0.001, betas = (0.9, 0.999)) # lr = 0.001
